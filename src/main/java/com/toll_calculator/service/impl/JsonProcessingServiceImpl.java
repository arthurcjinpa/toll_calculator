...
/**
 * This is an implementation of the JsonProcessingService interface,
 * here we convert to List and save data from our json file.
 * I've decided to create a difference interface and methods for this logic
 * so as not to violate the SOLID principles.
 *
